...
# If summerR repository is not loaded, please download it here https://github.com/SummerTold/summeR
...
df %>% 
  ...
  geom_point(aes(color = Country)) +
  geom_smooth(method = "lm", formula = y ~ x) +
  labs(x = "Old-age-dependency ratio", y = element_blank(), 
       title = "Capital-per-worker (in log)") +
  theme_bw()
```
