...
tab_demo70 = list.sim$benchmark %>% 
  ...
  mutate(
    "var" = c("$n_{1970}$", "$p_{1970}$", "$p_{2010}$", "$\\frac{p_{1970}}{n_{1970}}$", "$\\eta_{1970}$"),
    "Variable" = c("Population growth", "Survival rate", "Expected survival rate", "Old-age-dependency ratio", "Young political power")) %>% 
...
graph_pgsr_counter +
  ...
  ggsave(file.path(loc_graphic, "quant-counter-pgsr.png"), width = 7, height = 7/1.5)
...
graph_pgsr_counter +
  ...
  ggsave(file.path(loc_graphic, "quant-counter-pgsr-color.png"), width = 7, height = 7/1.5)
