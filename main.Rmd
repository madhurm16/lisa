...
I start loading all the initial script. If the summeR repository is not loaded, please download it [here](https://github.com/FabienPetitEconomics/summeR). Place the summeR repository in the same folder as this repository.
