...
redis = baseline %>%
  ...
  select(Country, Year, wL, rK, wL_net, rK_net, gov_rev, unemp_ben, health_spen,
         C1, Saving, C2, inc_y, inc_o, Y, theta) %>% 
  ungroup()
...
redis %>% 
  ...
  labs(x = "", y = "Share of GDP") +
  theme(legend.position = "bottom") +
  ggsave("stacked_test3.png", width = 1920/1080*5, height = 5)
...
decomp %>% 
  ...
  theme(legend.position = "none", legend.direction = "vertical") +
  labs(x = "Year", y = "Labor income share") +
  ggsave(file.path(loc_dev, "counter_facet_SR.png"), width = 1920/1080*5, height = 5)
