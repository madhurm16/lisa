...
decomp2 %>% 
  subset(variable %in% c("FDE.TIE", "TDE.FIE")) %>% 
  subset(break_year == 1970) %>% 
...
decomp_mean.period %>% 
  ...
  scale_fill_manual(name = "",
                    breaks = c("TPG.FSR.share", "FPG.TSR.share",
                               "FDE.TIE.share", "TDE.FIE.share"),
                    labels = c("Survival rate", "Population growth",
                               "Direct cohort", "Indirect cohort"),
                    values = brewer.pal(8, "Set1")[c(2,3,5,8)] %>% 
                      setNames(c("TPG.FSR.share", "FPG.TSR.share",
                                 "FDE.TIE.share", "TDE.FIE.share"))) +
  theme_classic(base_size = 14) +
  theme(legend.position = "bottom") +
  labs(x = "", y = "Percent") +
